...
export default function Product_Categories({navigation,route}) {
  ...
  const ListRender = list.map((item) =><View key={item.id} style={{marginVertical:20, flexDirection: "row", height: heightItem }}>
            <TouchableOpacity style={{ width: "40%", position: "relative" }} 
            ...
            <View style={{ flex: 1, marginLeft: 20 }}>
              ...
              >
                ...
                >
                  <Ionicons
                    ...
                    style={{ marginRight: 5 }}
                  />
                  <Text style={{ fontSize: 10, fontWeight: "bold" }}>{item.rate}</Text>
                </View>
                <Text
                  style={{
                    fontSize: 10,
              ...
              <View style={{flexDirection: 'row', marginVertical: 15}}>
                {item.discount ? (
                <>
                  <Text style={{fontWeight: "bold",fontSize: 13}}>${item.price * item.discount}</Text>
                  <Text style={{fontWeight: "normal",fontSize: 13,color: "#c3c3c3",marginLeft: 10,textDecorationLine: "line-through" }}>${item.price}</Text>
              ...
              {item.discount ? (
              <View style={{flexDirection: 'row', alignItems: "center", paddingTop: 10, borderTopColor: "#f9f9f9",borderTopWidth: 2 }}>
                <View style={{height: 20,width:20,marginRight: 10}}>
                  ...
                  <Text style={{color: "#c3c3c3",fontWeight: 'normal',fontSize:10}}>{item.discount*100}% of upto $100</Text>
